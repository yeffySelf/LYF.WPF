...
namespace WPFCustomControls
{
    ...
    public class EditableTextBlockAdorner : Adorner
    {
        ...
        public event MouseEventHandler TextBoxMouseEnter
        {
            add
            {
                _textBox.MouseEnter += value;
            }
            remove
            {
                _textBox.MouseEnter -= value;
    ...
    public class EditableTextBlockBorderAdorner : Adorner
    {
        private readonly TextBlock _textBox;
        public EditableTextBlockBorderAdorner(TextBlock adornedElement) : base(adornedElement)
        {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            drawingContext.DrawRectangle(null, new Pen(new SolidColorBrush(Colors.Black), 1), new Rect(0, 0, _textBox.DesiredSize.Width, _textBox.DesiredSize.Height));
        }
    }
}
